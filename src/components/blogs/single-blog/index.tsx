...
export default function SingleBlog({
  ...
  return (
    <div className="shadow-xl mt-8 ml-8 border border-grey ">
      <div className="relative overflow-hidden rounded-md bg-white  dark:bg-dark ">
        <Link className="  relative block h-[250px] w-full" href={"/"}>
          <span className="absolute top-6 right-6 z-20 inline-flex items-center justify-center rounded-full bg-primary py-2 px-4 text-sm font-semibold capitalize text-white ">
            {category}
          </span>
          <Image src={"/noImage3.png"} alt="Blog Post" fill />
        </Link>
      </div>
          ...
          <div className="  flex items-center xl:mr-3 xl:pr-3 2xl:mr-5 2xl:pr-5">
            <div className="  mr-4">
              <div className=" h-10 relative w-10 overflow-hidden rounded-full">
                <Image src={"/noImage.png"} alt="Author" fill />
              </div>
            </div>
