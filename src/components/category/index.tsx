              ...
              <div className="mb-10 rounded-md bg-primary bg-opacity-5 dark:bg-opacity-10">
                ...
                <ul className=" p-8">
                  {relatedBlogs && relatedBlogs.length ? (
                        ...
                        <div className="flex items-center lg:block xl:flex">
                          <div className="mr-5 lg:mb-3 xl:mb-0">
                            <div className="relative h-[60px] w-[70px] overflow-hidden rounded-md sm:h-[75px] sm:w-[85px]">
                              <Image src={"/noImage3.png"} alt="Blog" fill />
                            </div>
                          </div>
                          <div className="w-full">
                            <h5>
                              <Link
                                href={`/blogs/${item.id}`}
                                className="mb-[8px] block text-base font-medium text-white dark:text-white hover:text-primary dark:hover:text-primary"
                              >
                                {item.title}
                              </Link>
                            </h5>
                    ...
                    <h1 className="text-white">No Related blogs available</h1>
                  )}
                </ul>
              </div>
            </div>
